...
public class InMemoryAuthenticationService implements AuthenticationService {
    ...
    /**
     * Number of iterations used for password hashing - use large value to protect tokens
     * from brute force attacks in case of leakage
     */
    private static final int PASSWORD_HASHING_ITERATION_COUNT = 50000; // change to lower value for faster test execution
    /**
     * Size of autogenerated salt for passwords. Should be long enough to protect from dictionary attacks
     * in case of token leakage
     */
    private static final int PASSWORD_SALT_LENGTH = 32;
    private static final String PASSWORD_HASHING_ALGO = "PBKDF2WithHmacSHA1";

    /**
     * Users database (includes password hashes and role assignments) - to be protected and persisted
     */
    final ConcurrentHashMap<String, UserRecord> users = new ConcurrentHashMap<>();
    /**
     * Roles database - to be persisted
     */
    final ConcurrentHashMap<String, RoleImpl> roles = new ConcurrentHashMap<>();
    /**
     * Token service contains database of invalidated tokens which is to be persisted
     */
    ...
    /**
     * change to tweak username policy
     */
    final Pattern usernamePattern = Pattern.compile("^\\w{3,}$");
    /**
     * change to tweak password policy (might need to be refactored into separate class hierarchy if
     * customization/configurability is required)
     */
